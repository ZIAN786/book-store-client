...
export default function Home() {
    ...
    return (
     <div>
        <Jumbotron 
        title="E-Marketing" subTitle="Welcome To The Fashion Web"/>

        <div className="row">
          <div className="col-md-6">
          <h2 className="p-3 mt-2 mb-2 h4 bg-primary  text-center" >New Arrivals</h2>
          ...
          <div className="col-md-6">
          <h2 className="p-3 mt-2 mb-2 h4 bg-success text-center" >Best Sellers</h2>
